...
Arguments:
 ...
 [-model ARG]            . LLM model to use (options: 'any', 'any_fast', 'any_slow', 'gpt-5.4-mini', 'gpt-5.4-nano', 'gpt-5.1', 'gpt-5.2', 'gpt-5.2-codex', 'gpt-5.5', 'gpt-5.6-sol', 'gpt-5.6-terra', 'gpt-5.6-luna', 'gpt-mock-web-search', 'claude-haiku-4-5', 'claude-opus-4-5', 'claude-opus-4-6', 'claude-opus-4-8', 'claude-sonnet-4-5', 'claude-sonnet-4-6', 'claude-sonnet-5', 'claude-fable-5', 'claude-mock-local-tool-use', 'claude-mock-web-search', 'gemini-2.5-flash', 'gemini-2.5-pro', 'gemini-3.1-pro-preview', 'gemini-mock-web-search', 'mercury-2') (default: 'any_fast')
