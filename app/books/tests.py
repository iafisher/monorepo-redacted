    ...
    def test_parse_one_line(self):
        ...
        self.assertEqual(
            Book(
                ...
                date_started=dt.date(2025, 1, 8),
                date_finished=dt.date(2025, 1, 10),
                pages=216,
            ),
            book,
        )
        ...
        self.assertEqual(
            Book(
                title="Ghosts",
                author="Paul Auster",
                date_started=dt.date(2025, 6, 2),
                date_finished=dt.date(2025, 6, 2),
                pages=74,
            ),
            book,
        )
        ...
        self.assertEqual(
            Book(
                ...
                date_started=dt.date(2024, 5, 16),
                date_finished=dt.date(2024, 6, 8),
                pages=177,
            ),
            book,
        )
        ...
        self.assertEqual(
            Book(
                ...
                date_started=dt.date(2023, 12, 29),
                date_finished=dt.date(2024, 1, 2),
                pages=225,
            ),
            book,
        )
        ...
        self.assertEqual(
            Book(
                ...
                date_started=dt.date(2022, 1, 21),
                date_finished=dt.date(2022, 3, 24),
                pages=1085,
            ),
            book,
        )
        ...
        self.assertEqual(
            Book(
                title="Anna Karenina",
                author="Leo Tolstoy",
                date_started=dt.date(2024, 10, 1),
                date_finished=dt.date(2024, 11, 26),
                pages=None,
            ),
            book,
        )
        ...
        self.assertEqual(
            Book(
                ...
                date_started=dt.date(2023, 4, 1),
                date_finished=dt.date(2023, 4, 14),
                pages=325,
            ),
            book,
        )
        ...
        self.assertEqual(
            Book(
                ...
                date_started=dt.date(2024, 6, 1),
                date_finished=dt.date(2024, 6, 1),
                pages=None,
            ),
            book,
        )
        ...
        self.assertEqual(
            Book(
                ...
                author="Dan Wang",
                date_started=dt.date(2025, 10, 5),
                date_finished=dt.date(2025, 10, 14),
                pages=None,
            ),
            book,
        )
